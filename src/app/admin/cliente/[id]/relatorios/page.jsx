...
function codigoReceita(tipo) {
  ...
  if (t.includes("renda fixa") || t.includes("rf"))
    ...
    <div className="mx-auto max-w-7xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-400">
          Prévia institucional e exportação PDF para {nomeCliente}
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <aside className="space-y-4 rounded-2xl border border-slate-800 bg-slate-900/60 p-5 lg:col-span-1">
          ...
          <p className="text-[11px] text-slate-500">
            O ano-calendário filtra dividendos e vendas no Kit do Contador.
          </p>
        ...
        <div className="lg:col-span-2">
          <div className="overflow-auto rounded-2xl border border-slate-800 bg-slate-950/50 p-4 sm:p-6">
            <div
              id="documento-pdf"
              className="mx-auto w-full max-w-[720px] bg-white p-8 text-slate-900 shadow-xl aspect-[1/1.414]"
              style={{ minHeight: "calc(720px * 1.414)", height: "auto" }}
            >
              <header className="border-b border-gray-300 pb-4">
                <p className="font-serif text-2xl font-bold tracking-tight text-slate-900">
                  LEXTOR Wealth Management
                </p>
              ...
              <footer className="mt-8 border-t border-gray-200 pt-4 text-[10px] leading-relaxed text-slate-400">
                Documento gerado automaticamente pela plataforma LEXTOR.
                Informações auxiliares para o contador — não substituem
                assessoria contábil/fiscal formal. Investimentos envolvem riscos.
              </footer>
            </div>
          </div>
        </div>
